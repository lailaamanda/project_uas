              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="navbarLightDropdownMenuLink" 
                 role="button" data-bs-toggle="dropdown" aria-expanded="false" style="color : #fff;" 
                  onmouseover="this.style.color=' #13547a'" " 
                   onmouseout="this.style.color='#fff'">Kabupaten / Kota</a>

                <ul class="dropdown-menu dropdown-menu-light" aria- 
                 labelledby="navbarLightDropdownMenuLink">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarLightDropdownMenuLink" 
                     role="button" data-bs-toggle="dropdown" aria-expanded="false">Peta Tematik Data 
                      Non Spasial</a>

                    <ul class="dropdown-menu dropdown-menu-light" aria- 
                     labelledby="navbarLightDropdownMenuLink">
                        <li><a class="dropdown-item" href="/kabkota/penduduk">Kepadatan Penduduk</a> 
                         </li>
                        <li><a class="dropdown-item" href="/kabkota/rumah_sakit">Jumlah Rumah 
                             Sakit</a></li>
